...
function liu_lan_5s() {
    ...
    if (!get_image_coordinates("mei_ri_lai_ling.jpg") && !get_image_coordinates("song_shu.jpg")) {
        ...
        for (i = 0; i < 7; i++) {
            ...
            sleep(2000);
            if (!get_image_coordinates("que_ding_button.jpg") && get_image_coordinates("lan_tian.jpg")) {
                sleep(2000)
                is_click("liu_lan_qi_ta.jpg"); sleep(1500);
            }
            else {
                is_click("que_ding_button.jpg");
                break
...
ui.layout(
    <vertical padding="16">
        <button id="click_me" text="美团领水果" w="auto"/>
    </vertical>
);
